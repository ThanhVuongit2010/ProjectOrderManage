...
public class EllipTextView extends TextView {
    ...
    private final List<EllipsizeListener> mEllipsizeListeners = new ArrayList<EllipTextView.EllipsizeListener>();
    ...
    public EllipTextView(Context context, AttributeSet attrs, int defStyle) {
