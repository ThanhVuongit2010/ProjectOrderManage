...
public class AppState {
	...
	//--------------------------------------------------------------------------------------------------------------------
	public static String sListArticleFrom = "";
	//--------------------------------------------------------------------------------------------------------------------
...
//	}
	 ...
	 * @return
	 */
//	public ErrorPopUp showInternetErrorPopUp(final Activity activity) {
//		String title = "接続エラー";
//		String message = activity.getResources().getString(R.string.internet_error_message);
//		mErrorPopUp = new ErrorPopUp(activity, null, message).setTitle(title); 
